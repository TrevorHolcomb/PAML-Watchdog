...
(MessageTypeId, Id, Name, [Description], Expression, AlertTypeId, SupportCategoryId, RuleCreator, EscalationChainId, Engine, Origin, [Server], DefaultSeverity, RuleCategoryId)
VALUES
(1, 1, 'rule1', 'generated by dbo.Rules.data.sql', 'QueueSize > 50000', 1, 1, 'a SQL script', 1, 1, 1, 1, 1, 1);
