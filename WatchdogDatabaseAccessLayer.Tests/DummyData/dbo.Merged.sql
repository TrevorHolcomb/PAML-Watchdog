...
(MessageTypeName, Id, Name, [Description], Expression, AlertTypeId, SupportCategoryId, RuleCategoryId, RuleCreator, EscalationChainId, EngineName, Origin, [Server], DefaultSeverity)
VALUES
('TestMessageType', 1, 'rule1', 'generated by dbo.Rules.data.sql', 'QueueSize > 50000', 1, 1, 1, 'a SQL script', 1, 'WatchdogMessageGenerator', 1, 1, 1);
