...
(MessageTypeName, Id, Name, [Description], Expression, AlertTypeId, SupportCategoryId, RuleCategoryId, RuleCreator, DefaultSeverity, Engine, [Server], Origin, [Timestamp])
VALUES
('Test Message Type', 1, 'rule1', 'generated by dbo.Merged.sql', 'QueueSize > 50000', 1, 1, 1, 'a SQL script', 1, 'JCaps', 'some server', 'outer space', '1970-01-01 00:00:00.000');
